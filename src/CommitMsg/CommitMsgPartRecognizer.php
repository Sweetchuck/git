 ...
 * @phpstan-import-type SweetchuckGitCommitMsgParts from \Sweetchuck\Git\Phpstan
 */
class CommitMsgPartRecognizer
{
    ...
    /**
     * @phpstan-param SweetchuckGitCommitMsgParts $parts
     *
     * @throws \LogicException
     */
    ...
    /**
     * @phpstan-param SweetchuckGitCommitMsgPart $oldValue
     * @param array<string, string> $replacementPairs
     *
     * @phpstan-return SweetchuckGitCommitMsgPart
     */
